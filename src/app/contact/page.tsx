		...
		<div className="bg-background min-h-screen">
			...
			<div className="bg-foreground text-white py-24 md:py-32 rounded-b-[40px] md:rounded-b-[80px] text-center px-4 relative overflow-hidden">
				...
				<p className="text-xl text-white/70 max-w-2xl mx-auto relative z-10">
					Have a question about bulk orders, shipping, or our premium products?
					We are here to help.
				</p>
			</div>
							...
							<form className="space-y-6">
								<div className="grid md:grid-cols-2 gap-6">
									<div className="space-y-2">
										...
										<Input
											placeholder="John"
											className="h-14 bg-surface-alt border-transparent focus:border-primary"
										/>
									</div>
									<div className="space-y-2">
										<label className="text-sm font-bold uppercase tracking-wider text-text-secondary">
								...
								<Button
									size="lg"
									className="w-full md:w-auto px-12 h-14 rounded-2xl font-bold shadow-lg shadow-primary/30"
								>
