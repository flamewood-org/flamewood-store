...
export function AuthModal() {
	...
	return (
		<div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
			...
			>
				<div className="sticky top-0 z-10 flex items-center justify-between gap-3 border-b border-border/80 bg-surface/95 backdrop-blur-sm px-4 py-3">
					<h2
						id="auth-modal-title"
					...
					<button
						type="button"
						onClick={close}
						className="p-2 rounded-lg text-text-secondary hover:bg-surface-alt hover:text-foreground transition-colors"
						aria-label="Close"
					>
						<X className="w-5 h-5" />
					</button>
