			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-12">
				...
				<div className="grid lg:grid-cols-2 gap-12 lg:gap-24 mb-20">
					<div>
						...
						<p className="text-lg text-text-tertiary mb-8 leading-relaxed max-w-md">
							Premium biomass fuel and coconut products sourced directly from the heart of Kerala, India. Prepared for excellence.
						</p>
						<div className="flex space-x-4">
							<a href="#" className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center hover:bg-primary transition-colors text-white" aria-label="Instagram">
							...
							<a href="#" className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center hover:bg-primary transition-colors text-white" aria-label="Facebook">
							...
							<a href="#" className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center hover:bg-primary transition-colors text-white" aria-label="Twitter">
					...
					<div className="bg-white/5 rounded-[32px] p-8 md:p-10 border border-white/10">
						...
						<p className="text-text-tertiary mb-8 leading-relaxed">
							Subscribe for exclusive offers, early access to new products, and industry insights.
						</p>
						<form
				...
				<div className="grid grid-cols-2 md:grid-cols-4 gap-12 border-t border-white/10 pt-16">
					...
					<div>
						...
						<ul className="space-y-4 text-sm font-medium">
							<li>
								<Link href="/products/all" className="text-text-tertiary hover:text-white transition-colors group flex items-center">
									All Products
							...
							<li>
								<Link href="/products/firewood" className="text-text-tertiary hover:text-white transition-colors group flex items-center">
									Firewood
									<ArrowRight className="w-3 h-3 ml-2 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" />
								</Link>
							</li>
							<li>
								<Link href="/products/coconut" className="text-text-tertiary hover:text-white transition-colors group flex items-center">
									Coconut Products
									<ArrowRight className="w-3 h-3 ml-2 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" />
								</Link>
							</li>
							<li>
								<Link href="/products/biomass" className="text-text-tertiary hover:text-white transition-colors group flex items-center">
									Biomass
									<ArrowRight className="w-3 h-3 ml-2 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" />
								</Link>
							</li>
					...
					<div>
						...
						<ul className="space-y-4 text-sm font-medium">
							<li><Link href="/contact" className="text-text-tertiary hover:text-white transition-colors">Contact Us</Link></li>
							<li><Link href="/track-order" className="text-text-tertiary hover:text-white transition-colors">Track Order</Link></li>
							<li><Link href="/about" className="text-text-tertiary hover:text-white transition-colors">About Us</Link></li>
							<li><Link href="/shipping" className="text-text-tertiary hover:text-white transition-colors">Shipping Info</Link></li>
						</ul>
					</div>
					...
					<div>
						...
						<ul className="space-y-4 text-sm font-medium">
							<li><Link href="/privacy" className="text-text-tertiary hover:text-white transition-colors">Privacy Policy</Link></li>
							<li><Link href="/terms" className="text-text-tertiary hover:text-white transition-colors">Terms of Service</Link></li>
							<li><Link href="/refunds" className="text-text-tertiary hover:text-white transition-colors">Refund Policy</Link></li>
						</ul>
					</div>
					...
					<div className="col-span-2 md:col-span-1">
						...
						<div className="space-y-4 text-sm text-text-tertiary font-medium">
							<div className="flex items-start gap-3">
								...
								<span>Kochi EXZ, Ernakulam<br />Kerala, India 682001</span>
							</div>
							<div className="flex items-center gap-3">
								<Mail className="h-5 w-5 text-primary flex-shrink-0" />
								<a href="mailto:support@flamewood.com" className="hover:text-white transition-colors">support@flamewood.com</a>
							</div>
							<div className="flex items-center gap-3">
				...
				<div className="border-t border-white/10 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
					...
					<div className="flex items-center gap-2">
						...
						<div className="w-10 h-6 bg-white/10 rounded flex items-center justify-center text-[10px] font-bold text-white/50">AMEX</div>
					</div>
				</div>
			</div>
		</footer>
